...
from .build_reviewer_template import generate_build_reviewer_template
from .plan_generator_template import generate_plan_generator_template
...
AGENT_TEMPLATE_FUNCTIONS: dict[str, Callable[..., str]] = {
    ...
    'build-reviewer': generate_build_reviewer_template,
    'plan-generator': generate_plan_generator_template,
    'plan-critic': generate_plan_critic_template,
