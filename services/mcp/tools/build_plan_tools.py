...
class BuildPlanTools:
    ...
    def store_build_plan(self, plan: BuildPlan, loop_id: str) -> MCPResponse:
        try:
            ...
            raise ToolError('Invalid build plan: cannot be None')
...
def register_build_plan_tools(mcp: FastMCP) -> None:
    ...
    async def store_build_plan(loop_id: str, plan_markdown: str, ctx: Context) -> MCPResponse:
        ...
        """
        await ctx.info(f'Parsing and storing build plan with loop_id: {loop_id}')
